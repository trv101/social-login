        ...
        <a href="{{ route('google-auth') }}"
           class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 focus:outline-none focus:border-red-700 focus:ring focus:ring-red-200 active:bg-red-600 disabled:opacity-25 transition">
            <svg class="w-5 h-5 mr-2" viewBox="0 0 488 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M488 261.8C488 403.3 391.1 512 256 512 114.6 512 0 397.4 0 256S114.6 0 256 0c69.6 0 132.7 25.4 181.3 67.1l-73.4 70.4C325.5 91.5 292.1 80 256 80c-97.2 0-176 79.4-176 176s78.8 176 176 176c88.8 0 146.4-62.8 152.3-119H256v-94.2h232z"/>
            </svg>
